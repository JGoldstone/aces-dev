...
// <ACEStransformID>ODT.Academy.P3D65_ST2084_108.a1.0.3</ACEStransformID>
// <ACESuserName>ACES 1.0 Output - P3-D65 ST2084 (108 nits)</ACESuserName>

// 
// Output Device Transform - P3D65 (108 cd/m^2)
//

//
// Summary :
//  This transform is intended for mapping OCES onto an HDR projector calibrated 
//  to P3 primaries and a D65 white point at 108 cd/m^2. The assumed observer 
...
)
{
    ...
    float rgbPost[3];
    rgbPost[0] = segmented_spline_c9_fwd( rgbPre[0], ODT_108nits);
    rgbPost[1] = segmented_spline_c9_fwd( rgbPre[1], ODT_108nits);
    rgbPost[2] = segmented_spline_c9_fwd( rgbPre[2], ODT_108nits);
    ...
    // This scales absolute luminance to CV 0-1, then rescales CV to luminance but 
    // keeping black at 0 instead of converting it back to 0.0001
    float outputCV[3] = Y_2_ST2084_f3( clamp_f3( linCV_2_Y_f3( Y_2_linCV_f3( rgb, 108., 0.0001), 108., 0.), 0.0, HALF_POS_INF));
